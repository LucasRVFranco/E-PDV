 ...
 //                   .setProperty("hibernate.dialect", "org.hibernate.dialect.MySQLDialect")
   //                 .setProperty("hibernate.connection.driver_class", "com.mysql.jdbc.Driver")
      //              .setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/sistemapdv")
                   ...
                   .setProperty("hibernate.connection.url", "jdbc:postgresql://localhost:5432/post_db")
                    .setProperty("hibernate.connection.username", "usr_post")
                    .setProperty("hibernate.connection.password", "post9090")
